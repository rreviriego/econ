...
#LAS CRIPTOMONEDAS FRENTE A LAS POLÍTICAS DE EXPANSIÓN CUANTITATIVA:
...
fed <- ts(data$FED, start = c(2013,41), frequency = 52)
rates <- ts(data$Rates, start = c(2013,41), frequency = 52)
